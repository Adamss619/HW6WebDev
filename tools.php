...
?>
  <html>
   <head>
    ...
    <div id="pagetitle">TOOLS</div>
    <div id="pagetitlesub">Freedom With Finance</div>

            
    <div class="articlerow">
       <div class="article">
           <div class="articelTitle"><img class="articlephoto" src="/Tracing.svg" alt="">MINT</div>
<!--           <img class="articlephoto" src="/Tracing.svg" alt="">-->
       ...
       <div class="article">
           <div class="articelTitle"><img class="articlephoto" src="/Tracing.svg" alt="">TOOL3</div>
       </div>
    </div>
